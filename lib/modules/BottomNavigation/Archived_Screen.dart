    ...
    return BlocConsumer<AppCubit,AppStates>(
      ...
      builder: (context,state){
        ...
        return ConditionalBuilder(
          condition: appCubit.ArchivedTask.length > 0,
          builder: (context) => ListView.separated(
            itemBuilder: (context, index) {
              return doItem(appCubit.ArchivedTask, index,context);
            },
            ...
            itemCount: appCubit.ArchivedTask.length,
          ),
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(
                  onPressed: (){
                    AppCubit.get(context).updateDatabase(status: 'new', id: jobs[index]['id']);
                  },
                  icon: Icon(Icons.repeat_on_outlined,color: Colors.blue, size: 21,)),
              IconButton(
                  onPressed: (){
